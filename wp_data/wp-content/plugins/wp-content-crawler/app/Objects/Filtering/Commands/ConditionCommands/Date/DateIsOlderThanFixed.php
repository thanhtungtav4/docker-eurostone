...
class DateIsOlderThanFixed extends AbstractFixedDateConditionCommand {

    public function getKey(): string {
        return CommandKey::DATE_IS_OLDER_THAN_FIXED;
    }

    public function getName(): string {
        return _wpcc('Is older than fixed date');
    }

    protected function getInputDescription(): string {
        return _wpcc('The subject date must be older than this date.');
    }
